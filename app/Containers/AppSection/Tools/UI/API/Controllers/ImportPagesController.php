...
use App\Containers\AppSection\Tools\UI\API\Requests\ImportPagesRequest;
use App\Containers\AppSection\Tools\UI\API\Transformers\DataSynchronizeImportTransformer;
use App\Ship\Parents\Controllers\ApiController;
use Illuminate\Http\JsonResponse;

final class ImportPagesController extends ApiController
{
    public function __invoke(
        ImportPagesRequest $request,
